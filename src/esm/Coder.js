...
import SLD from "./SecondLevelDomains"
...
function generateAccessor(_group, _part) {
...
function generateSegmentedPathFunction(_sep, _codingFuncName, _innerCodingFuncName) {
  return function(string) {
...
URI.prototype.valueOf = URI.prototype.toString
